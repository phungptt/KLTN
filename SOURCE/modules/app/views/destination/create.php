...
<section class="flat-listing">
    <div class="content" id="create-destination-page">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <?php $form = ActiveForm::begin([
                        ...
                        <div class="inner-box style3">
                            <label for="">Hình ảnh mô tả điểm đến</label>
            ...
            methods: {
                ...
                createPlace: function(event) {
                    ...
                    var _this = this,
                        ...
                        formData = new FormData($('#create-destination-form')[0]);
                    ...
                    $.ajax({
                        ...
                        processData: false,
                        type: 'POST',
                        url: '<?= APPConfig::getUrl('destination/create') ?>',
                        data: formData,
